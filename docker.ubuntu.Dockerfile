# With Ubuntu, need to install Python with apt. 
# Ubuntu 25.10 and 25.04 install Python 3.13, which does not work does not with TensorBoard.
# Ubuntu 24.10 installs Python 3.12 (and PyTorch 2.7.1), which does work with TensorBoard. 
FROM ubuntu:24.10
